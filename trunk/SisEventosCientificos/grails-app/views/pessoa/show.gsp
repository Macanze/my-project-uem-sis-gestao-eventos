                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: pessoaInstance, field: "email")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: pessoaInstance, field: "endereco")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="pessoa.telefoneCelular.label" default="Telefone Celular" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: pessoaInstance, field: "telefoneCelular")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="pessoa.telefoneFixo.label" default="Telefone Fixo" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: pessoaInstance, field: "telefoneFixo")}</td>
